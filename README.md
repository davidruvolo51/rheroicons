...
The `rheroicons` packages brings to the [heroicons](https://github.com/refactoringui/heroicons) icon library, developed by [adamwathan](https://github.com/adamwathan) and [sschoger](https://github.com/sschoger), as R functions for use in your R-based web projects (i.e., shiny, Rmarkdown, etc.).

All icons are rendered as inline svg icons. Therefore, no css or js dependencies are loaded into your Shiny application, Rmd file, or other web document at runtime!
...
Click an icon name to copy the R code used to generate the icon. You can paste the R code directly into your Shiny app, Rmd file, or other web-based project.
