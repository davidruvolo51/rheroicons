...
solid$adjustments <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-adjustments", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M5 4a1 1 0 00-2 0v7.268a2 2 0 000 3.464V16a1 1 0 102 0v-1.268a2 2 0 000-3.464V4zM11 4a1 1 0 10-2 0v1.268a2 2 0 000 3.464V16a1 1 0 102 0V8.732a2 2 0 000-3.464V4zM16 3a1 1 0 011 1v7.268a2 2 0 010 3.464V16a1 1 0 11-2 0v-1.268a2 2 0 010-3.464V4a1 1 0 011-1z"))))
...
solid$annotation <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-annotation", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(`fill-rule` = "evenodd", 
...
solid$archive <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-archive", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M4 3a2 2 0 100 4h12a2 2 0 100-4H4z")), 
...
solid$arrow_circle_right <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-arrow_circle_right", 
    aria_hidden = aria_hidden, viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", 
        list(`fill-rule` = "evenodd", d = "M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 1.414L10.586 9H7a1 1 0 100 2h3.586l-1.293 1.293a1 1 0 101.414 1.414l3-3a1 1 0 000-1.414z", 
            `clip-rule` = "evenodd"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
...
solid$arrow_narrow_right <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-arrow_narrow_right", 
    aria_hidden = aria_hidden, viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", 
        list(`fill-rule` = "evenodd", d = "M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z", 
            `clip-rule` = "evenodd"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
...
solid$arrows_expand <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-arrows_expand", aria_hidden = aria_hidden, 
    viewbox = "0 0 19 20", fill = "currentColor", tag(`_tag_name` = "path", list(stroke = "#374151", 
...
solid$bell <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-bell", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$book_open <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-book_open", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M9 4.804A7.968 7.968 0 005.5 4c-1.255 0-2.443.29-3.5.804v10A7.969 7.969 0 015.5 14c1.669 0 3.218.51 4.5 1.385A7.962 7.962 0 0114.5 14c1.255 0 2.443.29 3.5.804v-10A7.968 7.968 0 0014.5 4c-1.255 0-2.443.29-3.5.804V12a1 1 0 11-2 0V4.804z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$bookmark <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-bookmark", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$chart_bar <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-chart_bar", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$chart_pie <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-chart_pie", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z")), 
...
solid$chat_alt_2 <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-chat_alt_2", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M2 5a2 2 0 012-2h7a2 2 0 012 2v4a2 2 0 01-2 2H9l-3 3v-3H4a2 2 0 01-2-2V5z")), 
...
solid$clipboard_check <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-clipboard_check", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M9 2a1 1 0 000 2h2a1 1 0 100-2H9z")), 
...
solid$clipboard_copy <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-clipboard_copy", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M8 2a1 1 0 000 2h2a1 1 0 100-2H8z")), 
...
solid$clipboard <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-clipboard", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z")), 
...
solid$cloud_download <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-cloud_download", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M6 13a4 4 0 010-8 4 4 0 118 0 4 4 0 010 8h-3V8a1 1 0 10-2 0v5H6zM9 13h2v2.586l1.293-1.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 111.414-1.414L9 15.586V13z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$collection <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-collection", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$credit_card <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-credit_card", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z")), 
...
solid$currency_dollar <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-currency_dollar", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M8.433 7.418c.155-.103.346-.196.567-.267v1.698a2.305 2.305 0 01-.567-.267C8.07 8.34 8 8.114 8 8c0-.114.07-.34.433-.582zM11 12.849v-1.698c.22.071.412.164.567.267.364.243.433.468.433.582 0 .114-.07.34-.433.582a2.305 2.305 0 01-.567.267z")), 
...
solid$document_duplicate <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-document_duplicate", 
    aria_hidden = aria_hidden, viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", 
        list(d = "M9 2a2 2 0 00-2 2v8a2 2 0 002 2h6a2 2 0 002-2V6.414A2 2 0 0016.414 5L14 2.586A2 2 0 0012.586 2H9z")), 
...
solid$dots_circle_horizontal <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-dots_circle_horizontal", 
    aria_hidden = aria_hidden, viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", 
        list(`fill-rule` = "evenodd", d = "M10 18a8 8 0 100-16 8 8 0 000 16zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z", 
            `clip-rule` = "evenodd"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
...
solid$dots_horizontal <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-dots_horizontal", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$dots_vertical <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-dots_vertical", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M10 6a2 2 0 110-4 2 2 0 010 4zM10 12a2 2 0 110-4 2 2 0 010 4zM10 18a2 2 0 110-4 2 2 0 010 4z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$duplicate <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-duplicate", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M7 9a2 2 0 012-2h6a2 2 0 012 2v6a2 2 0 01-2 2H9a2 2 0 01-2-2V9z")), 
...
solid$exclamation_circle <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-exclamation_circle", 
    aria_hidden = aria_hidden, viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", 
        list(`fill-rule` = "evenodd", d = "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z", 
            `clip-rule` = "evenodd"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
...
solid$external_link <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-external_link", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z")), 
...
solid$eye <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-eye", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M10 12a2 2 0 100-4 2 2 0 000 4z")), 
...
solid$fire <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-fire", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "g", list(`clip-path` = "url(#clip0)", 
...
solid$folder_add <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-folder_add", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z")), 
    tag(`_tag_name` = "path", list(stroke = "#fff", `stroke-linecap` = "round", `stroke-linejoin` = "round", 
...
solid$home <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-home", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$inbox_in <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-inbox_in", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M8.707 7.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l2-2a1 1 0 00-1.414-1.414L11 7.586V3a1 1 0 10-2 0v4.586l-.293-.293z")), 
...
solid$information_circle <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-information_circle", 
    aria_hidden = aria_hidden, viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", 
        list(`fill-rule` = "evenodd", d = "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z", 
            `clip-rule` = "evenodd"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
...
solid$light_bulb <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-light_bulb", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M11 3a1 1 0 10-2 0v1a1 1 0 102 0V3zM15.657 5.757a1 1 0 00-1.414-1.414l-.707.707a1 1 0 001.414 1.414l.707-.707zM18 10a1 1 0 01-1 1h-1a1 1 0 110-2h1a1 1 0 011 1zM5.05 6.464A1 1 0 106.464 5.05l-.707-.707a1 1 0 00-1.414 1.414l.707.707zM5 10a1 1 0 01-1 1H3a1 1 0 110-2h1a1 1 0 011 1zM8 16v-1h4v1a2 2 0 11-4 0zM12 14c.015-.34.208-.646.477-.859a4 4 0 10-4.954 0c.27.213.462.519.476.859h4.002z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$lock_open <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-lock_open", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M10 2a5 5 0 00-5 5v2a2 2 0 00-2 2v5a2 2 0 002 2h10a2 2 0 002-2v-5a2 2 0 00-2-2H7V7a3 3 0 015.905-.75 1 1 0 001.937-.5A5.002 5.002 0 0010 2z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$mail <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-mail", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z")), 
...
solid$moon <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-moon", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$pencil_alt <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-pencil_alt", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z")), 
...
solid$pencil <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-pencil", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$phone_incoming <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-phone_incoming", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M14.414 7l3.293-3.293a1 1 0 00-1.414-1.414L13 5.586V4a1 1 0 10-2 0v4.003a.996.996 0 00.617.921A.997.997 0 0012 9h4a1 1 0 100-2h-1.586z")), 
...
solid$phone_outgoing <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-phone_outgoing", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M17.924 2.617a.997.997 0 00-.215-.322l-.004-.004A.997.997 0 0017 2h-4a1 1 0 100 2h1.586l-3.293 3.293a1 1 0 001.414 1.414L16 5.414V7a1 1 0 102 0V3a.997.997 0 00-.076-.383z")), 
    tag(`_tag_name` = "path", list(d = "M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
...
solid$phone <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-phone", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$puzzle <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-puzzle", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M10 3.5a1.5 1.5 0 013 0V4a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-.5a1.5 1.5 0 000 3h.5a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-.5a1.5 1.5 0 00-3 0v.5a1 1 0 01-1 1H6a1 1 0 01-1-1v-3a1 1 0 00-1-1h-.5a1.5 1.5 0 010-3H4a1 1 0 001-1V6a1 1 0 011-1h3a1 1 0 001-1v-.5z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$question_mark_circle <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-question_mark_circle", 
    aria_hidden = aria_hidden, viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", 
        list(`fill-rule` = "evenodd", d = "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z", 
            `clip-rule` = "evenodd"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
...
solid$share <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-share", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M15 8a3 3 0 10-2.977-2.63l-4.94 2.47a3 3 0 100 4.319l4.94 2.47a3 3 0 10.895-1.789l-4.94-2.47a3.027 3.027 0 000-.74l4.94-2.47C13.456 7.68 14.19 8 15 8z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$shield_exclamation <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-shield_exclamation", 
    aria_hidden = aria_hidden, viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", 
        list(`fill-rule` = "evenodd", d = "M10 1.944A11.954 11.954 0 012.166 5C2.056 5.649 2 6.319 2 7c0 5.225 3.34 9.67 8 11.317C14.66 16.67 18 12.225 18 7c0-.682-.057-1.35-.166-2.001A11.954 11.954 0 0110 1.944zM11 14a1 1 0 11-2 0 1 1 0 012 0zm0-7a1 1 0 10-2 0v3a1 1 0 102 0V7z", 
            `clip-rule` = "evenodd"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
...
solid$shopping_bag <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-shopping_bag", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(stroke = "#374151", 
        `stroke-linejoin` = "round", `stroke-width` = "2", d = "M5 8h10l1 9H4l1-9z")), 
    tag(`_tag_name` = "path", list(stroke = "#374151", `stroke-width` = "2", d = "M7 6a3 3 0 013-3v0a3 3 0 013 3v3a3 3 0 01-3 3v0a3 3 0 01-3-3V6z")), 
    tag(`_tag_name` = "rect", list(width = "2", height = "2", x = "6", y = "9", rx = "1")), 
    tag(`_tag_name` = "rect", list(width = "2", height = "2", x = "12", y = "9", 
        rx = "1"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
...
solid$shopping_cart <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-shopping_cart", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$sort_ascending <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-sort_ascending", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M3 3a1 1 0 000 2h11a1 1 0 100-2H3zM3 7a1 1 0 000 2h5a1 1 0 000-2H3zM3 11a1 1 0 100 2h4a1 1 0 100-2H3zM13 16a1 1 0 102 0v-5.586l1.293 1.293a1 1 0 001.414-1.414l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 101.414 1.414L13 10.414V16z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$sort_descending <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-sort_descending", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M3 3a1 1 0 000 2h11a1 1 0 100-2H3zM3 7a1 1 0 000 2h7a1 1 0 100-2H3zM3 11a1 1 0 100 2h4a1 1 0 100-2H3zM15 8a1 1 0 10-2 0v5.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L15 13.586V8z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$star <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-star", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$switch_horizontal <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-switch_horizontal", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M8 5a1 1 0 100 2h5.586l-1.293 1.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L13.586 5H8zM12 15a1 1 0 100-2H6.414l1.293-1.293a1 1 0 10-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L6.414 15H12z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$switch_vertical <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-switch_vertical", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M5 12a1 1 0 102 0V6.414l1.293 1.293a1 1 0 001.414-1.414l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L5 6.414V12zM15 8a1 1 0 10-2 0v5.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L15 13.586V8z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$template <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-template", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$thumb_down <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-thumb_down", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M18 9.5a1.5 1.5 0 11-3 0v-6a1.5 1.5 0 013 0v6zM14 9.667v-5.43a2 2 0 00-1.105-1.79l-.05-.025A4 4 0 0011.055 2H5.64a2 2 0 00-1.962 1.608l-1.2 6A2 2 0 004.44 12H8v4a2 2 0 002 2 1 1 0 001-1v-.667a4 4 0 01.8-2.4l1.4-1.866a4 4 0 00.8-2.4z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$thumb_up <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-thumb_up", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$ticket <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-ticket", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M2 6a2 2 0 012-2h12a2 2 0 012 2v2a2 2 0 100 4v2a2 2 0 01-2 2H4a2 2 0 01-2-2v-2a2 2 0 100-4V6z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$user_add <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-user_add", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M8 9a3 3 0 100-6 3 3 0 000 6zM8 11a6 6 0 016 6H2a6 6 0 016-6zM16 7a1 1 0 10-2 0v1h-1a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1V7z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$user_group <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-user_group", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$user_remove <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-user_remove", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M11 6a3 3 0 11-6 0 3 3 0 016 0zM14 17a6 6 0 00-12 0h12zM13 8a1 1 0 100 2h4a1 1 0 100-2h-4z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$users <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-users", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$view_boards <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-view_boards", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M2 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1H3a1 1 0 01-1-1V4zM8 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1H9a1 1 0 01-1-1V4zM15 3a1 1 0 00-1 1v12a1 1 0 001 1h2a1 1 0 001-1V4a1 1 0 00-1-1h-2z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$view_grid_add <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-view_grid_add", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM14 11a1 1 0 011 1v1h1a1 1 0 110 2h-1v1a1 1 0 11-2 0v-1h-1a1 1 0 110-2h1v-1a1 1 0 011-1z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$view_grid <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-view_grid", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"))))
  if (!is.null(id) svg$attribs$id <- id
  if (!is.null(class) {
    svg$attribs$class <- paste0(svg$attribs$class, " ", class)
  }
...
solid$zoom_in <- function (id = NULL, class = NULL, aria_hidden = FALSE) {
  ...
  svg <- tag(`_tag_name` = "svg", list(class = "r-heriocons r-zoom_in", aria_hidden = aria_hidden, 
    viewbox = "0 0 20 20", fill = "currentColor", tag(`_tag_name` = "path", list(d = "M5 8a1 1 0 011-1h1V6a1 1 0 012 0v1h1a1 1 0 110 2H9v1a1 1 0 11-2 0V9H6a1 1 0 01-1-1z")), 
